...
resource "aws_instance" "mysql" {
  ...
  subnet_id = local.subnet_id
  iam_instance_profile = aws_iam_instance_profile.mysql.name # adding role to instance
  tags = merge(
    local.common_tags,
    {
...
#Adding role information in terraform instance_profile
resource "aws_iam_instance_profile" "mysql" {
  name = "mysql"
  role = "EC2accessSSM_role"
}
